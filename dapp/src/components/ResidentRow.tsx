...
import { isManager, Resident } from "../services/Web3Service";
...
function ResidentRow(props: Props) {
  ...
  function getNextPayment() {
    const nextPayment = ethers.toNumber(props.data.nextPayment);
    const dateMs = nextPayment * 1000;
      ...
      <td>
        {
          isManager() ?
            <>
              <a href={"/residents/edit/" + props.data.wallet} className="btn btn-info btn-sm me-1" data-toggle="tooltip">
